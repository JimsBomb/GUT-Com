...
public class WeiboTopicFollowDaoImpl extends HBaseSupport implements BaseDao<WeiboTopicFollow>
{
	private static String TAB_NAME = "weibo_topic_follow";

	@Override
	public void put(final WeiboTopicFollow instance)
	{
