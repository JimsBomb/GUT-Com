...
public class WeiboFollowGroupDaoImpl extends HBaseSupport implements BaseDao<WeiboFollowGroup>
{
	private static String TAB_NAME = "weibo_follow";

	@Override
	public void put(final WeiboFollowGroup instance)
	{
		ht.execute(TAB_NAME, new TableCallback<Result>()
				{
					...
					{
						Put p = new Put(Bytes.toBytes(instance.getGroupName()));
						htable.put(p);
						return null;
					}
