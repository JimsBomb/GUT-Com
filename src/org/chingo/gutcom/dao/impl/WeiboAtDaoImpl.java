...
public class WeiboAtDaoImpl extends HBaseSupport implements BaseDao<WeiboAt>
{
	private static String TAB_NAME = "weibo_at";

	@Override
	public void put(final WeiboAt instance)
	{
