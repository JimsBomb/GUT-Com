...
{
	private static String TAB_NAME = "common_filter_word";
	
	@Override
	public void put(final CommonFilterWord instance)
	{
		ht.execute(TAB_NAME, new TableCallback<Result>()
		{
			...
			{
				Put p = new Put(Bytes.toBytes(instance.getWord()));
				p.add(Bytes.toBytes("info"), Bytes.toBytes("level")
						, Bytes.toBytes(String.valueOf(instance.getLevel())));
				htable.put(p);
				return null;
			}
