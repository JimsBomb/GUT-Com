...
public class WeiboFavDaoImpl extends HBaseSupport implements BaseDao<WeiboFav>
{
	private static String TAB_NAME = "weibo_fav";

	@Override
	public void put(final WeiboFav instance)
	{
		ht.execute(TAB_NAME, new TableCallback<Result>()
				{
					...
					{
						Put p = new Put(Bytes.toBytes(instance.getFid()));
