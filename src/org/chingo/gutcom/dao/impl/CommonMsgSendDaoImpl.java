...
public class CommonMsgSendDaoImpl extends HBaseSupport implements BaseDao<CommonMsgSend>
{
	private static String TAB_NAME = "common_msg_send";

	@Override
	public void put(final CommonMsgSend instance)
	{
